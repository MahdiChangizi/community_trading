            ...
            <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-10 shadow-2xl relative overflow-hidden">
                ...
                <div class="relative z-10 text-center">
                    ...
                    <p class="text-xl text-gray-200 leading-relaxed">
                        Building an investment platform as the first step — creating income-generating opportunities through in-depth analysis of major global and crypto markets, enabling advanced trading capabilities, and ultimately constructing a centralized exchange. We empower individuals with the tools to achieve daily earnings, secure capital growth, and build long-term wealth through strategic investments — fostering a global community where investors thrive through transparent, secure, and profitable opportunities.
                    </p>
                </div>
            </div>
        </div>
