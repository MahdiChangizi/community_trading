        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex flex-1 justify-center">
                <div class="flex items-baseline space-x-6">
                    ...
                    <a href="{{ route('community') }}" class="text-gray-600 hover:text-primary-green px-3 py-2 rounded-md text-sm font-medium transition-colors">Bitorex community plan</a>
